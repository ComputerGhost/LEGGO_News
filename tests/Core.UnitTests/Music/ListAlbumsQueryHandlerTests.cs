...
{
    private Mock<ListAlbumsQuery.IDatabasePort> _mockDatabaseAdapter = null!;
    private ListAlbumsQuery.Handler _subject = null!;

    [TestInitialize]
    public void TestInitialize()
    {
        _mockDatabaseAdapter = new Mock<ListAlbumsQuery.IDatabasePort>();
        _subject = new ListAlbumsQuery.Handler(_mockDatabaseAdapter.Object);
    }
